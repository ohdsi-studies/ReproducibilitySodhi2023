...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44816332,45774435,1583722,44506754,793143,40170911)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (44816332,45774435,1583722,44506754,793143,40170911)
  and c.invalid_reason is null
